 ...
 */
public class HardQuizFragment extends Fragment implements View.OnClickListener {
    ...
    String TAG = "HardQuizFragment";

    NestedScrollView quizLayout;

    public static LinearLayout easyIntroLayout, hardCountdownLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_hard_quiz, container, false);
        ...
        hardCountdownLayout = (LinearLayout) v.findViewById(R.id.hardCountdownLayout);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.easyStartButton:
                ...
                hardCountdownLayout.setVisibility(View.VISIBLE);
                ...
                CountDownTimer gameStartTimer = new CountDownTimer(3500,1000) {
                    ...
                    public void onFinish() {
                        ...
                        hardCountdownLayout.setVisibility(View.GONE);
    ...
    private void exitGame(){
        ...
        builder.setPositiveButton("Exit", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                backStackCount++;
                fragmentTransaction.detach(HardQuizFragment.this);
    ...
    private void showResults(){
        ...
        final int bonus = secondsLeft/5;

        bonusPointsTV.setText(bonus+" points awarded\n(1 per 5s of time remaining)");
        ...
        GameModel gameModel = new GameModel(timestamp,"Hard", completedInString, timeLeft, bonus+" bonus points", correctAnswers+ "/50 ("+rightPercent+"%)",
        ...
        if(gameModel.getCompletionStatus().equals("Completed!")) {
            ...
            myDatabase.child("leaderboards").child("hard").child(thisEntry.getTotal() + " " + thisEntry.getBonus() + ": " + currentUser.getUid() + " " + gameModel.getTimestamp()).setValue(thisEntry);
        }
    }
