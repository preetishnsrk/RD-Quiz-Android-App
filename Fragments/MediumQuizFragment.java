 ...
 */
public class MediumQuizFragment extends Fragment implements View.OnClickListener {
    ...
    String TAG = "MediumQuizFragment";

    public static LinearLayout easyIntroLayout, mediumCountdownLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_medium_quiz, container, false);
        ...
        mediumCountdownLayout = (LinearLayout) v.findViewById(R.id.mediumCountdownLayout);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.easyStartButton:
                ...
                mediumCountdownLayout.setVisibility(View.VISIBLE);
                ...
                questionsArray.addAll(hardQuestionsArray);
                ...
                CountDownTimer gameStartTimer = new CountDownTimer(3500,1000) {
                    ...
                    public void onFinish() {
                        ...
                        mediumCountdownLayout.setVisibility(View.GONE);
            ...
            case R.id.exitButton:
                ...
                builder.setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        backStackCount++;
                        fragmentTransaction.detach(MediumQuizFragment.this);
    ...
    private void showResults(){
        ...
        final int bonus = secondsLeft/10;

        bonusPointsTV.setText(bonus+" points awarded\n(1 per 10s of time remaining)");
        ...
        GameModel gameModel = new GameModel(timestamp,"Medium", completedInString, timeLeft, bonus+" bonus points", correctAnswers+ "/50 ("+rightPercent+"%)",
        ...
        if(gameModel.getCompletionStatus().equals("Completed!")) {
            ...
            myDatabase.child("leaderboards").child("medium").child(thisEntry.getTotal() + " " + thisEntry.getBonus() + ": " + currentUser.getUid() + " " + gameModel.getTimestamp()).setValue(thisEntry);
