 ...
 */
public class EasyLeaderboard extends Fragment {

    ImageView easyLoadingGIF;

    String TAG = "EasyLeaderboardFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.fragment_easy_leaderboard, container, false);
        ...
        easyLoadingGIF = (ImageView) v.findViewById(R.id.easyLoadingGIF);

        recyclerView = (RecyclerView) v.findViewById(R.id.easyLeaderRecyclerList);
        ...
        Query getLeaderboard = myDatabase.child("leaderboards").child("easy");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    */
                    ...
                    easyLoadingGIF.setVisibility(View.GONE);
